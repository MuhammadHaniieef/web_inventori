    ...
    <div class="container d-flex justify-content-center align-items-center vh-100">
        <div class="row w-100 d-flex justify-content-center h-75">
            ...
            <div class="p-4 col-md-6 col-12 form-cont text-star"
                ...
                <h2 class="mb-4" style="color: #333;">Form pengajuan peminjaman</h2>
                <form action="{{ route('loans.name-submit') }}" method="POST">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="division" id="divisilain"
        ...
        document.querySelectorAll('.pilih-divisi').forEach(select => {
            select.addEventListener('change', function() {
                ...
                if (selectedValue === 'Lain') {
                    ...
                    divisilain.setAttribute('required', true);
                    divisilain.disabled = false;
                } else {
                    divisilain.classList.add('d-none');
                    divisilain.removeAttribute('required');
                    divisilain.disabled = true;
                }
            });
        });

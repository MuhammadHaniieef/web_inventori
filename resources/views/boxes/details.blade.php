...
<body>
    <div class="container-fluid mx-auto my-3">
        <h2 class="mb-4 text-center">Pengambilan Barang - Box: {{ $box->code }}</h2>
        @if (session('success'))
                ...
                <div class="table-responsive"> <table class="table table-bordered">
                    ...
                    <tbody>
                        @foreach ($items as $item)
                            <tr>
                                <td>
                                    <input type="text" name="items[{{ $item->id }}][name]" class="form-control"
                                        value="{{ $item->name }}">
                                </td>
                                <td>
                                    <input type="number" name="items[{{ $item->id }}][stock]" class="form-control"
                                        value="{{ $item->stock }}">
                                </td>
                            </tr>
                        @endforeach
